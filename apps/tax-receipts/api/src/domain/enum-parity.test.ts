...
const pairs: Array<[string, readonly string[], readonly string[]]> = [
  ...
  ['PaymentState', core.PaymentState.options, Object.values($Enums.PaymentState)],
  ['ContributionStatus', core.ContributionStatus.options, Object.values($Enums.ContributionStatus)],
