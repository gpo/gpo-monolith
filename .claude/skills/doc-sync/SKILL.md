---
name: doc-sync
description: Fold a code change into the area's memory docs. Use when the doc-sync Stop hook fires, or proactively after changing behaviour in an area listed in docs/doc-map.tsv.
---
...
7. **Commit docs with the code.** Doc edits ride in the same commit or PR as
   the change they describe, so review covers both together.
